...
def manually_fill():
    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            STUDENT_ENTRY = tk.Entry(
                MFW, width=20, bg="black", fg="red", font=("times", 23, " bold ")
            )
            ...
            def create_csv():
                df = pd.DataFrame(d)
                csv_name = (
                    "C:\\Users\\Dell\\OneDrive\\Desktop\\Attendance-Management-system-using-face-recognition-master\\Attendance(Manually)\\"
                    + subb
                    + "_"
                    + Date
                    + "_"
            ...
            def attf():
                ...
                subprocess.Popen(
                    r'explorer /select,"C:/Users/Dell/OneDrive/Desktop/Attendance-Management-system-using-face-recognition-master/Attendance(Manually)"'
                )
    ...
    SUB_ENTRY = tk.Entry(
        sb, width=20, bg="black", fg="red", font=("times", 23, " bold ")
    )
